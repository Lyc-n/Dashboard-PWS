...
function anggotaAge(record: KunjunganRumahRecord, anggotaId: string, ref: string): number | null {
...
export function kaderNameOf(record: KunjunganRumahRecord, staff: Staff[]): string | undefined {
